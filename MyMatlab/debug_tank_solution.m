...
%ncdir = '/local/tmp/1/ducousso/CROCO-NH/Tank_NHMG_1x1_1.5em1_1period_track_pb_modified_firststep_noUV_ADV/';
%ncdir = '/local/tmp/1/ducousso/CROCO-NH/Tank_NHMG_1x1_1.5em1_2period_track_pb_modified_firststep_noUV_ADV/';

ncdir = '/local/tmp/1/ducousso/CROCO-NH/Tank_NHMG_1x1_1.5em1_1period_track_pb_modified_firststep_noUV_ADV_long_without_coupling_check_solver/';
...
fl_u = ncread([ncdir 'fl_u_000_0' num2str(step) '.nc'],'u');
fl_w = ncread([ncdir 'fl_w_000_0' num2str(step) '.nc'],'w');
figure; 
...
so_uin = ncread([ncdir 'so_uin_000_0' num2str(1+(step-1)*2) '.nc'],'uin');
so_win = ncread([ncdir 'so_win_000_0' num2str(1+(step-1)*2) '.nc'],'win');
figure; 
...
% so_uin_diff = squeeze(so_uin(:,32,1:end)) + flipdim(squeeze(so_uin(:,32,1:end)),2);
% subplot(1,2,1); imagesc(so_uin_diff); axis xy; axis equal; axis tight; colorbar;
...
rhs_uf = ncread([ncdir 'rhs_uf_000_0' num2str(1+(step-1)*4) '.nc'],'uf');
rhs_wf = ncread([ncdir 'rhs_wf_000_0' num2str(1+(step-1)*4) '.nc'],'wf');
figure; 
subplot(1,2,1); imagesc(squeeze(rhs_uf(:,32,2:end  ))); axis xy; axis equal; axis tight; colorbar;
subplot(1,2,2); imagesc(squeeze(rhs_wf(:,32,2:end-1))); axis xy; axis equal; axis tight; colorbar

so_cA = ncread([ncdir 'so_cA_000_0' num2str(1+(step-1)*2) '.nc'],'cA');
so_b = ncread([ncdir 'so_b_000_0' num2str(1+(step-1)*2) '.nc'],'b');
so_p = ncread([ncdir 'so_p_000_0' num2str(1+(step-1)*2) '.nc'],'p');
so_r = ncread([ncdir 'so_r_000_0' num2str(1+(step-1)*2) '.nc'],'r');
figure; 
...
so_uout = ncread([ncdir 'so_uout_000_0' num2str(1+(step-1)*2) '.nc'],'uout');
so_wout = ncread([ncdir 'so_wout_000_0' num2str(1+(step-1)*2) '.nc'],'wout');
so_bout = ncread([ncdir 'so_bout_000_0' num2str(1+(step-1)*2) '.nc'],'bout');
figure;
...
co_uin = ncread([ncdir 'co_uin_000_0' num2str(1+(step-1)*2) '.nc'],'uin');
co_win = ncread([ncdir 'co_win_000_0' num2str(1+(step-1)*2) '.nc'],'win');
figure;
...
co_uf_bar = ncread([ncdir 'co_uf_bar_000_0' num2str(1+(step-1)*2) '.nc'],'uf_bar');
coin_uf1in = ncread([ncdir 'coin_uf1in_000_0' num2str(1+(step-1)*2) '.nc'],'uf1in');
coin_uf2in = ncread([ncdir 'coin_uf2in_000_0' num2str(1+(step-1)*2) '.nc'],'uf2in');
coin_ufin = ncread([ncdir 'coin_ufin_000_0' num2str(1+(step-1)*2) '.nc'],'ufin');
coin_ufout = ncread([ncdir 'coin_ufout_000_0' num2str(1+(step-1)*2) '.nc'],'ufout');
%coin_diff_uf = ncread([ncdir 'coin_diff_uf_000_0' num2str(1+(step-1)*2) '.nc'],'diff_uf');
figure; 
...
co_uout = ncread([ncdir 'co_uout_000_0' num2str(1+(step-1)*2) '.nc'],'uout');
co_wout = ncread([ncdir 'co_wout_000_0' num2str(1+(step-1)*2) '.nc'],'wout');
figure;
...
so_uin = ncread([ncdir 'so_uin_000_0' num2str(2+(step-1)*2) '.nc'],'uin');
so_win = ncread([ncdir 'so_win_000_0' num2str(2+(step-1)*2) '.nc'],'win');
figure; 
...
so_cA = ncread([ncdir 'so_cA_000_0' num2str(2+(step-1)*2) '.nc'],'cA');
so_b = ncread([ncdir 'so_b_000_0' num2str(2+(step-1)*2) '.nc'],'b');
so_p = ncread([ncdir 'so_p_000_0' num2str(2+(step-1)*2) '.nc'],'p');
so_r = ncread([ncdir 'so_r_000_0' num2str(2+(step-1)*2) '.nc'],'r');
figure; 
subplot(3,3,1); imagesc(squeeze(so_cA(6,:,32,2:end  ))); axis xy; axis equal; axis tight; colorbar;
subplot(3,3,4); imagesc(squeeze(so_cA(7,:,32,2:end  ))); axis xy; axis equal; axis tight; colorbar;
subplot(3,3,5); imagesc(squeeze(so_cA(1,:,32,2:end-1))); axis xy; axis equal; axis tight; colorbar;
...
so_uout = ncread([ncdir 'so_uout_000_0' num2str(2+(step-1)*2) '.nc'],'uout');
so_wout = ncread([ncdir 'so_wout_000_0' num2str(2+(step-1)*2) '.nc'],'wout');
%so_bout = ncread([ncdir 'so_bout_000_0' num2str(2+(step-1)*2) '.nc'],'bout');
figure;
...
co_uin = ncread([ncdir 'co_uin_000_0' num2str(2+(step-1)*2) '.nc'],'uin');
co_win = ncread([ncdir 'co_win_000_0' num2str(2+(step-1)*2) '.nc'],'win');
figure;
...
co_uf_bar = ncread([ncdir 'co_uf_bar_000_0' num2str(2+(step-1)*2) '.nc'],'uf_bar');
coin_uf1in = ncread([ncdir 'coin_uf1in_000_0' num2str(2+(step-1)*2) '.nc'],'uf1in');
coin_uf2in = ncread([ncdir 'coin_uf2in_000_0' num2str(2+(step-1)*2) '.nc'],'uf2in');
coin_ufin = ncread([ncdir 'coin_ufin_000_0' num2str(2+(step-1)*2) '.nc'],'ufin');
figure; 
...
co_uout = ncread([ncdir 'co_uout_000_0' num2str(2+(step-1)*2) '.nc'],'uout');
co_wout = ncread([ncdir 'co_wout_000_0' num2str(2+(step-1)*2) '.nc'],'wout');
figure;
