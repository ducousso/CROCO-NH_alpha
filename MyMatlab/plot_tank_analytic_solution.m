...
figure;
plot(x_r(:,1),zeta_nh,'o');title('analytic nh zeta');

figure;
subplot(1,2,1);
%plot(squeeze(z_u(33,:))-H,'o')
plot(squeeze(u_nh(33,:)),squeeze(z_u(33,:))-H,'o')
subplot(1,2,2);
%plot(squeeze(z_w(1,:))-H,'o')
plot(squeeze(w_nh(1,:)),squeeze(z_w(1,:))-H,'o')
...
pcolor(x_r_pc,z_w_pc-H,u_nh_pc);shading flat;
...
pcolor(x_u_pc,z_r_pc-H,w_nh_pc);shading flat;
